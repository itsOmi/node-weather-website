...
const forecast = (latitude, longitude, callback) => {
  const url = 'http://api.weatherstack.com/current?access_key=4191f02279cd2021a948689c89cad0e3&query=' + encodeURIComponent(latitude) + ',' + encodeURIComponent(longitude) + '&units=f'
